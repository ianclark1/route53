...
/*
	Created by 2010-12-06 Andrew Clarke <andrew@clarke.ca>
	Copyright 2010 by Andrew Clarke.  You are welcome to use this code, but please leave this copyright notice in place.

	Modified:
		- 2010-12-07
		- 2011-01-06 - createHostedZone() used to append a "." to the name property.  I've removed this, and now the trailing dot is required to be passed in.
*/